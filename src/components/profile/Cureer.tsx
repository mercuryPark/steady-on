...
const Career = () => {
  return (
    <div className="space-y-16 pt-12 text-start max-w-4xl">
      {/* Next.js 마이그레이션 프로젝트 */}
      <div className="space-y-8">
        ...
        <div>
          <SectionTitle
            emoji="🚀"
            title="기존에 개발된 메신저 Next.js로 마이그레이션"
          ...
          <div className="space-y-8 pl-4 mt-4">
            ...
            <SubSection number="01" title="사용자 인증">
              <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
                <li>
                  ...
                  도입하여, 사용자 로그인 시 <CodeBadge>accessToken</CodeBadge>
                  과 <CodeBadge>refreshToken</CodeBadge>을 발급하고, 이를{" "}
                  <CodeBadge>localStorage</CodeBadge>에 저장하여 세션을 관리
                </li>
                <li>
                  <span className="font-semibold">토큰 만료 처리</span>를 위해,{" "}
                  <CodeBadge>accessToken</CodeBadge>의{" "}
                  <CodeBadge>exp</CodeBadge> 클레임을 디코딩하여 만료 여부를
                  확인하고, 만료 시 <CodeBadge>refreshToken</CodeBadge>을
                  사용하여 새로운 토큰을 자동으로 재발급받는 로직을 구현
                </li>
                <li>
                  <span className="font-semibold">API 요청 최적화</span>를 위해,
                  토큰 디코딩을 통해 사용자 정보의 유효성을 사전에 검증하고,
                  유효하지 않은 경우 API 요청을 차단하여 불필요한 트래픽을
                  감소시킴
                </li>
              </ul>
            </SubSection>
            ...
            <SubSection number="02" title="Protected Route (인증보호 라우트)">
              <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
                <li>
                  <CodeBadge>Protected.tsx</CodeBadge> 컴포넌트를 통해 인증 보호
                  라우트를 구현, 이 컴포넌트는 로그인 시점과 페이지 새로고침
                  시에 실행되어 사용자 인증 상태와 웹소켓 연결 상태를 지속적으로
                  확인
                </li>
                <li>
            ...
            >
              <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
                <li>
                  Axios의 인스턴스와 인터셉터를 활용하여 API 요청 및 응답에 대한
                  중앙 집중식 미들웨어를 구축
                </li>
                <li>
                  요청 인터셉터에서는 사용자 인증을 위해{" "}
                  <CodeBadge>Bearer</CodeBadge> 토큰을 자동으로 헤더에 첨부하여,
                  모든 API 요청에 일관된 인증 처리를 보장
                </li>
                <li>
                  응답 인터셉터에서는 서버로부터의 에러 응답을 감지하여, 특히{" "}
                  <CodeBadge>410 Gone</CodeBadge> 및{" "}
                  <CodeBadge>419 Authentication Timeout</CodeBadge> 상태 코드에
                  대해 사용자 세션 만료로 간주하고 자동 로그아웃 처리 및
                  리디렉션 처리
                </li>
              </ul>
            </SubSection>
          ...
          <SubSection number="01" title="새 창 프로세스 도입">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                ...
                <CodeBadge>BroadcastChannel</CodeBadge>을 활용하여 메인 창과 새
                창 간의 실시간 데이터 동기화를 구현함으로써 중복 API 요청을
                최소화하고 성능을 최적화함
              </li>
            </ul>
          </SubSection>
          ...
          <SubSection number="02" title="IPC (Inter-Process Communication)">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                ...
                프로세스와 렌더러 프로세스 간의 효율적인 통신을 구현, 이를 통해
                Desktop에서의 알림 수신 및 표시, 다운로드 진행률 업데이트 등
                시스템 이벤트를 효과적으로 처리
              </li>
            </ul>
          </SubSection>
          ...
          <SubSection number="01" title="채팅방 상단고정 기능개발">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                ...
                및 사용자 인터랙션 등 다양한 시나리오를 고려하여 채팅방 리스트의
                정렬을 담당하는 공유 함수를 개발하여 실시간 데이터 반영과 일관된
                사용자 경험을 제공
              </li>
            </ul>
          </SubSection>
          ...
          <SubSection number="01" title="전역 스타일 관리(글꼴, 글자 크기)">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                ...
                <CodeBadge>font-family</CodeBadge> 속성으로 적용. 시스템에 해당
                글꼴이 없는 예외 상황까지 고려한 처리 로직을 추가해, 사용성의
                안정성과 예외 대응력을 향상
              </li>
            </ul>
          </SubSection>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-8 pl-4">
          ...
          >
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                데이터테이블 컴포넌트를 개발하여 파일 설치현황, 웹훅 관리, 파일
                저장 로그 등의 데이터를 효율적으로 표시하고 관리할 수 있는
                인터페이스 구현
              </li>
              <li>
                다양한 필터링 옵션을 제공하여 사용자가 원하는 데이터를 쉽게 찾을
                수 있도록 UX 개선
              </li>
            </ul>
          </SubSection>
          ...
          >
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                ...
                캐러셀을 구현하고, 실시간으로 테마 색상을 변경할 수 있는 스위치
                기능 개발
              </li>
              <li>
        ...
        <div className="space-y-8 pl-4">
          ...
          >
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              ...
              <li>
                <CodeBadge>Jest</CodeBadge>를 사용하여 Custom Hooks에 대한 단위
                테스트를 작성하고, 코드의 안정성과 신뢰성을 확보
              </li>
            </ul>
          </SubSection>
          ...
          <SubSection number="02" title="SVG 아이콘 컴포넌트 시스템 구축">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              ...
              <li>
                아이콘 컴포넌트를 개발하여 <CodeBadge>type</CodeBadge>과 스타일
                관련 props를 받아 동적으로 SVG 아이콘을 렌더링하고,{" "}
                <CodeBadge>stroke</CodeBadge>, <CodeBadge>fill</CodeBadge> 등의
                속성을 props로 제어하여 다양한 디자인을 단일 컴포넌트로 관리
              </li>
            </ul>
          </SubSection>
        </div>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-8 pl-4">
          {/* 클라이언트 버전 관리 */}
          <SubSection number="01" title="OS별 클라이언트 버전 통합 관리 시스템">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                <span className="font-semibold">데이터 테이블 기반</span>의 버전
                관리 인터페이스를 구현하여, Windows, macOS, iOS, Android 등
                다양한 OS별 클라이언트 버전을 효율적으로 관리할 수 있는 시스템
                개발
              </li>
              <li>
                <span className="font-semibold">일괄 작업 기능</span>을 도입하여
                다수의 클라이언트 정보를 한 번에 수정/삭제할 수 있도록
                구현함으로써, 운영팀의 작업 효율성을{" "}
          ...
          <SubSection number="02" title="실시간 웹소켓 접속 현황 모니터링">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
                ...
                대시보드를 개발, <CodeBadge>WebSocket</CodeBadge> 연결 상태, IP
                주소, OS 정보 등을 직관적으로 모니터링할 수 있는 인터페이스 구현
              </li>
              <li>
                실시간 데이터 업데이트를 위해{" "}
                <CodeBadge>Server-Sent Events</CodeBadge>를 활용하여 서버의 상태
                변경을 즉시 반영하도록 구현, 모니터링의 정확성과 신뢰성을 확보
              </li>
            </ul>
          </SubSection>

          {/* 서비스 알림 시스템 */}
          <SubSection number="03" title="타겟팅 가능한 서비스 알림/공지 시스템">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              <li>
        ...
        <div className="space-y-8 pl-4">
          ...
          <SubSection number="01" title="다중 사용자 중간지점 찾기 시스템">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              ...
              <li>
                <span className="font-semibold">단계별 상태 지속성</span>을 위해{" "}
                <CodeBadge>localStorage</CodeBadge>와 연동하여 페이지 새로고침
                시에도 진행 상태가 유지되도록 구현, 사용자 경험 개선
              </li>
            </ul>
          </SubSection>
          ...
          <SubSection number="02" title="하이브리드 지도 서비스 통합">
            <ul className="list-disc pl-4 space-y-3 text-gray-700 text-sm">
              ...
              <li>
                <span className="font-semibold">지도 API 추상화 레이어</span>를
                구축하여 여러 지도 서비스를 유연하게 전환할 수 있도록 설계, 향후
                다른 지도 서비스 통합 시 코드 수정을 최소화할 수 있는 확장성
                확보
              </li>
            </ul>
          </SubSection>
